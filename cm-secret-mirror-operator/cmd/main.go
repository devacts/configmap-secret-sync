...
import (
	...
	"github.com/devacts/cm-secret-mirror-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(secretmirrorv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ac337cc3.example.com",
